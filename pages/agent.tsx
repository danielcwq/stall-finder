...
import AgentFreeSearch from '../components/AgentFreeSearch';
...
export default function AgentDemo() {
    ...
    const [activeTab, setActiveTab] = useState<'guided' | 'free'>('free');
    ...
    return (
        <div className="flex flex-col items-center min-h-screen p-4 bg-gray-100">
            ...
            {activeTab === 'guided' ? (
                ...
                <AgentFreeSearch onSearch={handleAgentSearch} loading={loading} />
            )}
            ...
            <div className="mt-8 mb-4 flex flex-col items-center gap-2">
                <div className="flex gap-4 text-sm">
                    <a href="/" className="text-blue-600 hover:underline">← Main Search</a>
                    <a href="/compare" className="text-blue-600 hover:underline">A/B Compare</a>
                </div>
                <a
